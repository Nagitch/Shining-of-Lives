...
public class Push2Manager : MonoBehaviour
{
    ...
    /// Push2 status
    /// </summary>
    public Push2State push2State = Push2State.DEVICE_NOT_DETECTED;
    ...
    public static void WakeupPush2()
    {
        ...
        Push2.SetLED(Buttons.Play, LED.Color.RGB.Green, LED.Animation.PulsingHalf);
